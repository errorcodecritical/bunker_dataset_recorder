...
ros2 launch scovox_mapping lidar_mapping.launch.py params_file:="/ros2_ws/src/scovox/config/scovox_lidar_raw_deskew.yaml" pointcloud_topic:=/hesai/points use_sim_time:=false &
