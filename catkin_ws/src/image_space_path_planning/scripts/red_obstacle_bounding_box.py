#!/usr/bin/env python3
"""
red_obstacle_perception_single_target.py
...
class RedObstaclePerception:
    def __init__(self):
        ...
        rospy.loginfo("[red_obstacle_perception] single-target mode running")
    ...
    def image_callback(self, message):
        ...
        labels, blobs = self.find_obstacle_blobs(cleaned_mask)
        ...
        rospy.loginfo_throttle(
            1.0,
            "[perception] candidates=%d target=%s missed=%d max_danger=%.2f",
            len(blobs),
