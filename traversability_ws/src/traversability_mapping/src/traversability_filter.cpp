...
public:
    TraversabilityFilter():
        ...
        subCloud = nh.subscribe<sensor_msgs::PointCloud2>("/hesai/points", 5, &TraversabilityFilter::cloudHandler, this);
   ...
   void rebuildObstacleCloudFromHeightMap(){
    ...
    bool transformCloud(){
        ...
        try{listener.lookupTransform("map", "hesai_lidar", ros::Time(0), transform); }
        ...
        laserCloudIn->header.frame_id = "hesai_lidar"; // ??? this originally was "base"
